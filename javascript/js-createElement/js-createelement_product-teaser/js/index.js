...
for (let i = 0; i < buyButton.length; i++) {
  buyButton[i].addEventListener("click", (e) => {
    const parentProductEl = e.target.closest(".product");
    const name = parentProductEl.querySelector(".product__name").innerText;
    const price = parentProductEl.querySelector(".product__price").innerText;
